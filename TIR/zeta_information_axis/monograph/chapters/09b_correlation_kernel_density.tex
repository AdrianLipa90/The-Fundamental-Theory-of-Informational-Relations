...
Finite samples and finite translate families carry only \status{NUMERICAL\_DIAGNOSTIC} authority.  The theorem-level target retains its full quantifiers over every admissible $y$, all translates, and the complete space $L^1(\mathbb R)$.
