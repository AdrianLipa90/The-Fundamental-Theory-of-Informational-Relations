...
\texttt{heavy\_quark\_resonance} sector.  Hence a sector-invariant baseline
gives
...
\texttt{heavy\_quark\_resonance}, whereas tau belongs to
\texttt{charged\_lepton\_small\_seed}; therefore the baseline does not cancel
from $y_c/y_\tau$.
