...
This monograph presents the Theory of Informational Relations (TIR) in dependency order: primitive informational relations, emergent geometry, information/phase/flavour structure, particle and gauge sectors, and finally extensions, evidence and falsification gates. Version 12.2 is a GREMLIN-assisted repository consolidation through 18 September 2026. It preserves the v12.0 content-migration baseline and v12.1 repository synchronization as historical provenance while integrating previously isolated branch payloads without promoting unresolved physical claims.
...
Version 12.0 remains the dependency-ordered content-migration baseline and Version 12.1 remains the audited repository-synchronization layer. Version 12.2 adds the GREMLIN Pass-4 consolidation: exact Jarlskog closure, preservation of the CKM selector candidate chain without physical promotion, the golden-mean primitive-orbit theorem, the XF-9 provenance expansion, and a complete branch-containment audit. Formula ownership, validation ownership and current evidence verdict ownership remain separated explicitly.
