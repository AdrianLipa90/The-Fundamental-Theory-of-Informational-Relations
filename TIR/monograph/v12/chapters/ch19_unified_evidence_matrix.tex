...
\small
\begin{longtable}{p{0.20\textwidth}p{0.15\textwidth}p{0.15\textwidth}p{0.15\textwidth}p{0.27\textwidth}}
\toprule
...
Gauge/anomaly algebra & B & -- & OPEN & The PDG-2026 V2 matrix did not audit this sector; v12 Chapter~15 performs a fresh chirality/sign-convention audit before promotion. \\
...
\begin{align*}
\texttt{PASS\_COMPATIBILITY},\ \texttt{PASS\_STRONG\_COMPATIBILITY}
&\longrightarrow \texttt{COMPATIBLE},\\
\texttt{TENSION},\ \texttt{SCHEME\_UNDEFINED\_TENSION}
&\longrightarrow \texttt{TENSION},\\
\texttt{FAIL\_PRECISION},\ \texttt{FORMULA\_BROKEN},\ \texttt{FAIL\_PRECISION\_TENSION}
&\longrightarrow \texttt{FAIL},\\
\texttt{AMBIGUOUS\_COMPATIBILITY},\ \texttt{INCONCLUSIVE},\ \texttt{NOT\_TESTABLE\_CURRENTLY}
&\longrightarrow \texttt{OPEN},\\
\texttt{PROVENANCE\_CONTAMINATED},\ \texttt{PROVENANCE\_INCOMPLETE},\ \texttt{REPRODUCTION\_NOT\_VALIDATION}
