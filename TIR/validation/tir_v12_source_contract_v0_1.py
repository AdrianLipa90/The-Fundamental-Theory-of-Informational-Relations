...
def main() -> None:
    ...
    frontmatter = read(MONOGRAPH / "frontmatter/publication_frontmatter_v12_0.tex") if (MONOGRAPH / "frontmatter/publication_frontmatter_v12_0.tex").is_file() else ""
    ...
    receipt = {
        "schema": "TIR_V12_SOURCE_CONTRACT_V0_1",
