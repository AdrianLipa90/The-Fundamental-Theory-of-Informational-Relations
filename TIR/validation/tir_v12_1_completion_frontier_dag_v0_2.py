#!/usr/bin/env python3
"""Current fail-closed completion-frontier DAG for the TIR v12.1 publication sync."""
...
OPEN = {
    ...
    "QUARK_MASS_MAP": ["PLATONIC_L_CONSTANT_CLOSURE", "COEFFICIENT_MAGNITUDE_EXTRACTION"],
...
def main() -> int:
    ...
    checks = {
        ...
        "a2_is_closed_parent": "CARTAN_CONTINUUM_REFINEMENT_A2" in CLOSED,
        "a3_is_closed_parent": "ZERO_TORSION_LEVI_CIVITA_A3" in CLOSED,
        "a4_is_closed_parent": "LEADING_LOOP_METRIC_JET_A4" in CLOSED,
        "a5_certifier_is_closed_but_production_input_open": (
        ...
        "platonic_l_closure_is_parent_not_physical_promotion": "PLATONIC_L_CONSTANT_CLOSURE" in CLOSED,
        "rh_is_open_node": "RIEMANN_HYPOTHESIS" in OPEN,
        "evidence_rerun_downstream": order.index("RERUN_UNIFIED_EVIDENCE_MATRIX") > order.index("ELECTROWEAK_SCHEME_SCALE_CLOSURE"),
    ...
    receipt = {
        "schema": "TIR_V12_1_COMPLETION_FRONTIER_DAG_V0_2",
        "status": status,
