...
def main() -> None:
    ...
    checks = {
        ...
        "chapter13_exact_jarlskog": all(token in ch13 for token in ("2.97106576668", "Historical independent Jarlskog assignment: deprecated", "not the exact Jarlskog invariant", "independent CP assignment")),
