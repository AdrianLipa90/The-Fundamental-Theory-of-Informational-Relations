#!/usr/bin/env python3
"""Fail-closed source contract for TIR v12.2 GREMLIN Pass-4 consolidation."""
...
SYNC_MANIFEST = MONOGRAPH / "v12/MONOGRAPH_SYNC_V12_2.yaml"
...
def main() -> int:
    ...
    checks["master_is_v12_2_pass4_revision"] = "Version 12.2 GREMLIN Pass-4 Repository Consolidation" in master
    ...
    checks["completion_frontier_v12_1_current"] = all(token in ch21 for token in (
        "tir_v12_1_completion_frontier_dag_v0_3.py",
        "PRODUCTION\\_GLOBAL\\_SPATIAL\\_COMPLEX\\_INPUT",
        "PRODUCTION\\_INTERLEAF\\_MATCHING\\_FIELD\\_INPUT",
        "COEFFICIENT\\_TRANSITION\\_PARENT\\_SELECTOR",
        "RIEMANN\\_HYPOTHESIS",
    ))
    checks["coefficient_parent_evaluation_closed_in_frontier"] = (
        "coefficient parent evaluation (closed)" in ch21.lower()
        and "transition parent selector (open)" in ch21.lower()
    )
    ...
    checks["frontmatter_v12_2_status"] = "Version 12.2" in frontmatter and "GREMLIN-assisted repository consolidation" in frontmatter and "Jarlskog invariant exactly downstream" in frontmatter
    ...
    checks["sync_manifest_bound_to_pass4_baseline"] = (
        'version: "12.2-gremlin-pass4-repository-consolidation"' in sync_manifest
        and 'baseline_main: "45b54c0c8aa60ec92607e6132b69aca9ab766d75"' in sync_manifest
        and 'fully_contained_in_main: 77' in sync_manifest
        and 'unique_payload: 4' in sync_manifest
        and 'branch_deletion: false' in sync_manifest
    )
    ...
    receipt = {
        "schema": "TIR_V12_SOURCE_CONTRACT_V0_5",
        "technical_status": status,
        "supersedes": "TIR_V12_SOURCE_CONTRACT_V0_4",
