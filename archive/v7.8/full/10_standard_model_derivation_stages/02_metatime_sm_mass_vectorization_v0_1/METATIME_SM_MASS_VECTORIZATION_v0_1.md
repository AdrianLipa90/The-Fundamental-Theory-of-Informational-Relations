...
\[
G_{SM}^{global}=\frac{SU(3)_c\times SU(2)_L\times U(1)_Y}{\mathbb Z_6},
\]
...
\[
\frac1{2\pi}\oint_{\gamma_f}\mathcal A_{EBI}
...
y_f^{eff}
=\frac{\sqrt2}{v}
\left|\lambda_f\left(\hat{\mathcal M}_{hol}^{(f)}\right)\right|.
\]
...
=
M_0\,\Pi_{R,f}\,
\mathcal P\exp\left(i\oint_{\gamma_f}\mathcal A_{EBI}\right)\,
\Pi_{L,f}
...
\[
\hat M\Psi=\delta\alpha\sum_{i=0}^{\hat L-1}\log_2(\hat n_i)\Psi.
\]
